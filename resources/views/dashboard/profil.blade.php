...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
        ...
        <a href="{{ route('dashboard.kelas') }}" class="sidebar__link">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="6" r="3.5" stroke="currentColor" stroke-width="1.6"/><path d="M3 18c0-3.31 3.13-6 7-6s7 2.69 7 6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>
            Kelas Saya
        </a>
        @endif
        <a href="{{ route('profil.show') }}" class="sidebar__link sidebar__link--active">
    ...
    <div class="sidebar__user">
        ...
        <div><p class="sidebar__user-name">{{ $user->name }}</p><p class="sidebar__user-role">{{ ucfirst($user->role) }}</p></div>
    </div>
</aside>
